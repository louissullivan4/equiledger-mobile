...
const CreateExpenseScreen = ({ navigation, user, route }: CreateExpenseScreenProps) => {
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={styles.container}>
        ...
        <GenericTopBar heightPercentage={9} title={expenseToEdit ? 'Edit Expense' : 'New Expense'} />
          ...
          {isLoading ? (
            <View style={styles.loadingContainer}>
              ...
              <Text style={styles.loadingText}>
                {expenseToEdit ? 'Updating Expense...' : 'Submitting Expense...'}
              </Text>
            </View>
          ) : (
            <Animatable.View
                  ...
                  <View style={styles.buttonGroup}>
                    ...
                    >
                      <Text style={styles.anotherButtonText}>
                        {expenseToEdit ? 'Edit Another Expense' : 'Add Another Expense'}
                      </Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={styles.addExpenseButton}
                      onPress={() => navigation.navigate('ExpenseStack', { screen: 'ExpenseMain' })}
                    >
          ...
          {!isSuccess && !isLoading && (
            <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
              <Text style={styles.submitButtonText}>
                {expenseToEdit ? 'Update Expense' : 'Submit Expense'}
              </Text>
            </TouchableOpacity>
          )}
        </View>
